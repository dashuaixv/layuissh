...
PubUtil.prototype = {
	...
	load : function(body, array) {
		...
		var telArray = body.find("input[type='tel']");// 取到所有的input tel
		var hidden= body.find("input[type='hidden']");// 取到所有的input hidden
		var textarea= body.find("input[type='textarea']");// 取到所有的input textarea
		var textarea2= body.find("textarea");// 取到所有的input textarea2
