...
<form class="layui-form"  style="margin-top: 20px;" method="post" action="">
  <div class="layui-form-item">
      ...
      <div class="layui-input-inline">
        <select name="operSt" id="operSt"></select>
      </div>
...
layui.use(['form', 'layedit', 'laydate','jquery'], function(){
  ...
  var $ = layui.jquery;
   ...
   // C:\Program Files\JetBrains\IntelliJ IDEA 2018.2.2\plugins\JavaScriptLanguage\jsLanguageServicesImpl\external\lib.es5.d.ts  //获取传参
